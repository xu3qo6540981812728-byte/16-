...
const dynamicTexts = {
    strengths: {
        E: { high: "您是一位天生的社交家，能從與人互動中獲得源源不絕的能量，這讓您在開發客戶和建立人脈方面擁有巨大優勢。", mid: "您享受與人互動，能輕鬆地與客戶建立良好關係，這有助於您拓展業務網絡。" },
        I: { high: "您擁有強大的專注力和深度思考能力，善於一對一的深度溝通，這讓您能真正理解客戶內心深處的需求。", mid: "您傾向於先觀察再行動，透過深思熟慮建立的客戶關係，通常更加穩固和持久。" },
        S: { high: "您對事實和細節有著超乎常人的敏銳度，從屋況細節到合約條文，任何事都逃不過您的法眼，是客戶最安心的靠山。", mid: "您腳踏實地，注重實際，能為客戶提供具體、可靠的資訊，幫助他們做出務實的決定。" },
        N: { high: "您擁有卓越的遠見和洞察力，總能看到別人看不到的潛在價值與趨勢，特別適合為客戶規劃長遠的資產佈局。", mid: "您善於從大局思考，能幫助客戶跳脫框架，想像未來生活的美好藍圖。" },
        T: { high: "您是一位極度客觀的分析師，決策完全基於數據與邏輯，這讓您在談判和估價時非常專業，能為客戶爭取最大利益。", mid: "您處事公正、理性，能清晰地分析問題，即使在壓力下也能做出符合邏輯的判斷。" },
        F: { high: "您擁有極強的同理心，總能敏銳地捕捉到客戶的情緒與感受，並提供溫暖的支持，客戶不僅視您為仲介，更是值得信賴的朋友。", mid: "您重視和諧的人際關係，善於傾聽，能與客戶建立真誠的連結，讓交易過程充滿溫度。" },
        J: { high: "您是天生的管理者，任何複雜的流程在您手中都能變得井井有條。您的嚴謹規劃與超高執行力，是交易順利完成的最佳保證。", mid: "您喜歡有計畫地工作，做事有條理，能給客戶帶來很高的確定性和安全感。" },
        P: { high: "您是靈活應變的大師，市場或客戶的任何突發狀況都難不倒您。您總能跳出框架，找到創新的解決方案。", mid: "您對新事物抱持開放態度，能靈活調整策略，適應房仲工作中的各種變化與挑戰。" }
    }
};
